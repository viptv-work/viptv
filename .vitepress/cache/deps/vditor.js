...
// node_modules/.pnpm/vditor@3.9.6/node_modules/vditor/dist/index.min.js
var require_index_min = __commonJS({
  "node_modules/.pnpm/vditor@3.9.6/node_modules/vditor/dist/index.min.js"(exports, module) {
    !function(e, t) {
      ...
      var e = { 471: (e2) => {
        ...
        t2.Diff = function(e3, t3) {
          ...
          for (var m = o - a, f = m % 2 != 0, v = 0, h = 0, g = 0, y = 0, b = 0; b < l && !((/* @__PURE__ */ new Date()).getTime() > i); b++) {
            for (var w = -b + v; w <= b - h; w += 2) {
              for (var E = s + w, k = (C = w == -b || w != b && c[E - 1] < c[E + 1] ? c[E + 1] : c[E - 1] + 1) - w; C < o && k < a && e3.charAt(C) == r2.charAt(k); )
                C++, k++;
              if (c[E] = C, C > o)
                h += 2;
              else if (k > a)
                ...
                if ((M = s + m - w) >= 0 && M < d && -1 != u[M]) {
                  if (C >= (L = o - u[M]))
                    return this.diff_bisectSplit_(e3, r2, C, k, i);
                }
              }
            }
            for (var S = -b + g; S <= b - y; S += 2) {
              for (var L, M = s + S, T = (L = S == -b || S != b && u[M - 1] < u[M + 1] ? u[M + 1] : u[M - 1] + 1) - S; L < o && T < a && e3.charAt(o - L - 1) == r2.charAt(a - T - 1); )
                L++, T++;
              if (u[M] = L, L > o)
                y += 2;
              else if (T > a)
        ...
        var r2 = n2(478), i = n2(156), o = n2(314), a = n2(730), l = n2(66), s = n2(218), d = n2(702), c = function(e3) {
        ...
        }, u = n2(466), p = n2(554), m = n2(40), f = n2(563), v = n2(749), h = n2(818), g = n2(408), y = n2(54), b = n2(227), w = n2(526), E = n2(827), k = n2(640), S = n2(895), L = n2(393), M = function(e3, t3) {
          ...
          var t3 = { anchor: 0, cdn: y.g.CDN, customEmoji: {}, emojiPath: (e3 && e3.emojiPath || y.g.CDN) + "/dist/images/emoji", hljs: y.g.HLJS_OPTIONS, icon: "ant", lang: "zh_CN", markdown: y.g.MARKDOWN_OPTIONS, math: y.g.MATH_OPTIONS, mode: "light", speech: { enable: false }, theme: y.g.THEME_OPTIONS };
          return (0, k.T)(t3, e3);
        }, _ = function(e3, t3) {
          var n3 = A(t3);
          ...
          e3.querySelectorAll("pre > code").forEach(function(t3, n3) {
            ...
            if (!t3.parentElement.classList.contains("vditor-wysiwyg__pre") && !t3.parentElement.classList.contains("vditor-ir__marker--pre") && !(t3.classList.contains("language-mermaid") || t3.classList.contains("language-flowchart") || t3.classList.contains("language-echarts") || t3.classList.contains("language-mindmap") || t3.classList.contains("language-plantuml") || t3.classList.contains("language-markmap") || t3.classList.contains("language-abc") || t3.classList.contains("language-graphviz") || t3.classList.contains("language-math") || t3.style.maxHeight.indexOf("px") > -1 || e3.classList.contains("vditor-preview") && n3 > 5)) {
              ...
              if (t3.classList.contains("highlight-chroma")) {
                ...
                d.innerHTML = t3.innerHTML, d.querySelectorAll(".highlight-ln").forEach(function(e4) {
                  e4.remove();
                }), s = d.innerText;
              } else
              ...
              u.className = "vditor-copy", u.innerHTML = '<span aria-label="' + ((null === (o2 = window.VditorI18n) || void 0 === o2 ? void 0 : o2.copy) || "复制") + `"
...
onclick="this.previousElementSibling.select();document.execCommand('copy');this.setAttribute('aria-label', '` + ((null === (l = window.VditorI18n) || void 0 === l ? void 0 : l.copied) || "已复制") + `')">` + c + "</span>";
              ...
              p.value = (0, r2.X)(s), u.insertAdjacentElement("afterbegin", p), t3.before(u), t3.style.maxHeight = window.outerHeight - 40 + "px", t3.insertAdjacentHTML("afterend", '<span style="position: absolute">' + i.g.ZWSP + "</span>");
            }
          });
        };
      }, 66: (e2, t2, n2) => {
                ...
                (0, i.G)(t3.cdn + "/dist/js/katex/mhchem.min.js", "vditorKatexChemScript").then(function() {
                  n3.forEach(function(e4) {
                    if (!e4.parentElement.classList.contains("vditor-wysiwyg__pre") && !e4.parentElement.classList.contains("vditor-ir__marker--pre") && !e4.getAttribute("data-math")) {
                      ...
                      try {
                        e4.innerHTML = katex.renderToString(t4, { displayMode: "DIV" === e4.tagName, output: "html" });
                      } catch (t5) {
    ...
    <div class="vditor-img__img" onclick="this.parentElement.outerHTML = '';document.body.style.overflow = ''">
      ...
      return (() => {
        ...
        var e2, t2 = n(872), i = n(54), o = n(51), a = function(e3) {
          ...
          if (e3.previousElementSibling && e3.previousElementSibling.classList.contains("vditor-toc")) {
            if ("Backspace" === n2.key && 0 === (0, D.im)(e3, t3[t3.currentMode].element, r2).start)
              return e3.previousElementSibling.remove(), dt(t3), true;
            if (nt(t3, n2, r2, e3, e3.previousElementSibling))
              return true;
          }
          ...
          if (w("SpinVditorIRDOM", h2, "argument", e3.options.debugger), h2 = e3.lute.SpinVditorIRDOM(h2), w("SpinVditorIRDOM", h2, "result", e3.options.debugger), f2)
            ...
            if (L2) {
              var M2 = L2.textContent, T2 = M2.substring(1, M2.indexOf("]:")), C2 = e3.ir.element.querySelector('sup[data-type="footnotes-ref"][data-footnotes-label="' + T2 + '"]');
              C2 && C2.setAttribute("aria-label", M2.substr(T2.length + 3).trim().substr(0, 24));
            }
          }
          ...
          x2.forEach(function(e4, t4) {
            ...
            N(t4, e3);
          }), O(e3), Ct(e3, { enableAddUndoStack: true, enableHint: true, enableInput: true });
        }, P = function(e3, t3) {
          if ("" === e3)
            return false;
            ...
            if ("deleteContentBackward" === t3.inputType) {
              ...
              if (d2) {
                ...
                if ("code-block-close-marker" === d2.getAttribute("data-type")) {
                  if (c2 = Ne(i2, "code-block-open-marker"))
                    return c2.textContent = d2.textContent, void Ie(e3);
                }
                if ("code-block-open-marker" === d2.getAttribute("data-type")) {
                  if (c2 = Ne(i2, "code-block-close-marker", false))
                    return c2.textContent = d2.textContent, void Ie(e3);
                }
              }
              ...
              if (u2) {
                ...
                return void (p2 && "math-block-close-marker" === p2.getAttribute("data-type") && (p2.remove(), Ie(e3)));
              }
          ...
          if (o2 && "$$" === o2.textContent.trimRight())
            ...
            var f2, v2 = o2.textContent, h2 = o2.isEqualNode(e3.sv.element);
            h2 ? v2 = o2.textContent : (o2.previousElementSibling && (v2 = o2.previousElementSibling.textContent + v2, o2.previousElementSibling.remove()), o2.previousElementSibling && 0 === v2.indexOf("---\n") && (v2 = o2.previousElementSibling.textContent + v2, o2.previousElementSibling.remove()), o2.innerText.startsWith("```") || (e3.sv.element.querySelectorAll("[data-type='link-ref-defs-block']").forEach(function(e4, t4) {
              0 === t4 && e4 && !o2.isEqualNode(e4.parentElement) && (v2 += "\n" + e4.parentElement.textContent, e4.parentElement.remove());
            }), e3.sv.element.querySelectorAll("[data-type='footnotes-link']").forEach(function(e4, t4) {
              0 === t4 && e4 && !o2.isEqualNode(e4.parentElement) && (v2 += "\n" + e4.parentElement.textContent, e4.parentElement.remove());
            }))), v2 = De(v2, e3), h2 ? o2.innerHTML = v2 : o2.outerHTML = v2;
            var g2, b2 = e3.sv.element.querySelectorAll("[data-type='link-ref-defs-block']");
            b2.forEach(function(e4, t4) {
              0 === t4 ? f2 = e4.parentElement : (f2.lastElementChild.remove(), f2.insertAdjacentHTML("beforeend", "" + e4.parentElement.innerHTML), e4.parentElement.remove());
            ...
            w2.forEach(function(e4, t4) {
              0 === t4 ? g2 = e4.parentElement : (g2.lastElementChild.remove(), g2.insertAdjacentHTML("beforeend", "" + e4.parentElement.innerHTML), e4.parentElement.remove());
            }), w2.length > 0 && e3.sv.element.insertAdjacentElement("beforeend", g2), (0, D.ib)(e3.sv.element, r2), Ae(e3), Ie(e3, { enableAddUndoStack: true, enableHint: true, enableInput: true });
          }
        }, U = n(227), W = function(e3) {
        ...
        var F, Z, J = function(t3) {
          G(t3), K(), window.addEventListener("resize", e2 = function() {
            z(t3), G(t3);
          });
          ...
          clearTimeout(e3.wysiwyg.hlToolbarTimeoutId), e3.wysiwyg.hlToolbarTimeoutId = window.setTimeout(function() {
            if ("false" !== e3.wysiwyg.element.getAttribute("contenteditable") && (0, D.Gb)(e3.wysiwyg.element)) {
              ...
              if (r2)
                return e3.wysiwyg.popover.innerHTML = "", ce(r2, e3), void ae(e3, r2);
              var o2 = (0, y.lG)(n2, "LI");
              ...
              if (g2)
                return e3.wysiwyg.popover.innerHTML = "", ce(g2, e3), void ae(e3, g2);
              var w2 = (0, b.S)(n2, "BLOCKQUOTE");
              if (w2 && (e3.wysiwyg.popover.innerHTML = "", se(t3, w2, e3), de(t3, w2, e3), ce(w2, e3), ae(e3, w2)), o2 && (e3.wysiwyg.popover.innerHTML = "", se(t3, o2, e3), de(t3, o2, e3), ce(o2, e3), ae(e3, o2)), v2) {
                ...
                var E2 = function() {
                  ...
                  at(v2, n3), "right" === n3 ? (T2.classList.remove("vditor-icon--current"), C2.classList.remove("vditor-icon--current"), A2.classList.add("vditor-icon--current")) : "center" === n3 ? (T2.classList.remove("vditor-icon--current"), A2.classList.remove("vditor-icon--current"), C2.classList.add("vditor-icon--current")) : (C2.classList.remove("vditor-icon--current"), A2.classList.remove("vditor-icon--current"), T2.classList.add("vditor-icon--current")), (0, D.Hc)(t3), Y(e3);
                }, S2 = (0, y.lG)(n2, "TD"), L2 = (0, y.lG)(n2, "TH"), M2 = "left";
                S2 ? M2 = S2.getAttribute("align") || "left" : L2 && (M2 = L2.getAttribute("align") || "center");
                var T2 = document.createElement("button");
                T2.setAttribute("type", "button"), T2.setAttribute("aria-label", window.VditorI18n.alignLeft + "<" + (0, d.ns)("⇧⌘L") + ">"), T2.setAttribute("data-type", "left"), T2.innerHTML = '<svg><use xlink:href="#vditor-icon-align-left"></use></svg>', T2.className = "vditor-icon vditor-tooltipped vditor-tooltipped__n" + ("left" === M2 ? " vditor-icon--current" : ""), T2.onclick = function() {
                  k2("left");
                };
                var C2 = document.createElement("button");
                C2.setAttribute("type", "button"), C2.setAttribute("aria-label", window.VditorI18n.alignCenter + "<" + (0, d.ns)("⇧⌘C") + ">"), C2.setAttribute("data-type", "center"), C2.innerHTML = '<svg><use xlink:href="#vditor-icon-align-center"></use></svg>', C2.className = "vditor-icon vditor-tooltipped vditor-tooltipped__n" + ("center" === M2 ? " vditor-icon--current" : ""), C2.onclick = function() {
                  k2("center");
                };
                var A2 = document.createElement("button");
                A2.setAttribute("type", "button"), A2.setAttribute("aria-label", window.VditorI18n.alignRight + "<" + (0, d.ns)("⇧⌘R") + ">"), A2.setAttribute("data-type", "right"), A2.innerHTML = '<svg><use xlink:href="#vditor-icon-align-right"></use></svg>', A2.className = "vditor-icon vditor-tooltipped vditor-tooltipped__n" + ("right" === M2 ? " vditor-icon--current" : ""), A2.onclick = function() {
                  k2("right");
                };
                ...
                Z2.appendChild(R2), R2.type = "number", R2.min = "1", R2.className = "vditor-input", R2.style.width = "42px", R2.style.textAlign = "center", R2.setAttribute("placeholder", window.VditorI18n.row), R2.value = v2.rows.length.toString(), R2.oninput = function() {
                  ...
                  if (!n3.isComposing)
                    return "Tab" === n3.key ? (q2.focus(), q2.select(), void n3.preventDefault()) : void (ie(e3, n3) || me(n3, t3));
                };
                ...
                P2.appendChild(q2), q2.type = "number", q2.min = "1", q2.className = "vditor-input", q2.style.width = "42px", q2.style.textAlign = "center", q2.setAttribute("placeholder", window.VditorI18n.column), q2.value = v2.rows[0].cells.length.toString(), q2.oninput = function() {
                  ...
                  if (!n3.isComposing)
                    return "Tab" === n3.key ? (R2.focus(), R2.select(), void n3.preventDefault()) : void (ie(e3, n3) || me(n3, t3));
                }, se(t3, v2, e3), de(t3, v2, e3), ce(v2, e3), e3.wysiwyg.popover.insertAdjacentElement("beforeend", T2), e3.wysiwyg.popover.insertAdjacentElement("beforeend", C2), e3.wysiwyg.popover.insertAdjacentElement("beforeend", A2), e3.wysiwyg.popover.insertAdjacentElement("beforeend", x2), e3.wysiwyg.popover.insertAdjacentElement("beforeend", _2), e3.wysiwyg.popover.insertAdjacentElement("beforeend", O2), e3.wysiwyg.popover.insertAdjacentElement("beforeend", H2), e3.wysiwyg.popover.insertAdjacentElement("beforeend", I2), e3.wysiwyg.popover.insertAdjacentElement("beforeend", j2), e3.wysiwyg.popover.insertAdjacentElement("beforeend", Z2), e3.wysiwyg.popover.insertAdjacentHTML("beforeend", " x "), e3.wysiwyg.popover.insertAdjacentElement("beforeend", P2), ae(e3, v2);
              }
              ...
              if (V2) {
                ...
                Z2.appendChild(U2), U2.className = "vditor-input", U2.setAttribute("placeholder", window.VditorI18n.footnoteRef + "<" + (0, d.ns)("⌥Enter") + ">"), U2.style.width = "120px", U2.value = V2.getAttribute("data-footnotes-label"), U2.oninput = function() {
                  ...
                  n3.isComposing || ie(e3, n3) || me(n3, t3);
                }, ce(V2, e3), e3.wysiwyg.popover.insertAdjacentElement("beforeend", Z2), ae(e3, V2);
              }
              ...
              if (e3.wysiwyg.element.querySelectorAll(".vditor-wysiwyg__preview").forEach(function(e4) {
                ...
                if (e3.wysiwyg.popover.innerHTML = "", se(t3, W2, e3), de(t3, W2, e3), ce(W2, e3), "code-block" === W2.getAttribute("data-type")) {
              ...
              if (h2) {
                ...
                Z2.appendChild(J2), J2.className = "vditor-input", J2.setAttribute("placeholder", "ID<" + (0, d.ns)("⌥Enter") + ">"), J2.style.width = "120px", J2.value = h2.getAttribute("data-id") || "", J2.oninput = function() {
                  ...
                  n3.isComposing || ie(e3, n3) || me(n3, t3);
                }, se(t3, h2, e3), de(t3, h2, e3), ce(h2, e3), e3.wysiwyg.popover.insertAdjacentElement("beforeend", Z2), ae(e3, h2);
              }
              if (f2 && pe(e3, f2, t3), !(w2 || o2 || v2 || W2 || f2 || B2 || V2 || h2 || g2)) {
                var X2 = (0, y.a1)(n2, "data-block", "0");
                X2 && X2.parentElement.isEqualNode(e3.wysiwyg.element) ? (e3.wysiwyg.popover.innerHTML = "", se(t3, X2, e3), de(t3, X2, e3), ce(X2, e3), ae(e3, X2)) : e3.wysiwyg.popover.style.display = "none";
              }
              e3.wysiwyg.element.querySelectorAll('span[data-type="backslash"] > span').forEach(function(e4) {
                e4.style.display = "none";
              });
              var Q2 = (0, y.a1)(t3.startContainer, "data-type", "backslash");
              Q2 && (Q2.querySelector("span").style.display = "inline");
            }
          }, 200);
        }, ae = function(e3, t3) {
          ...
          i2.appendChild(o2), o2.className = "vditor-input", o2.setAttribute("placeholder", window.VditorI18n.textIsNotEmpty), o2.style.width = "120px", o2.value = t3.getAttribute("alt") || t3.textContent, o2.oninput = function() {
            ...
            ie(e3, r3) || me(r3, n2) || ue(e3, t3, r3, l2);
          };
          ...
          a2.appendChild(l2), l2.className = "vditor-input", l2.setAttribute("placeholder", window.VditorI18n.linkRef), l2.value = t3.getAttribute("data-link-label"), l2.oninput = function() {
            ...
            ie(e3, r3) || me(r3, n2) || ue(e3, t3, r3, o2);
          }, ce(t3, e3), e3.wysiwyg.popover.insertAdjacentElement("beforeend", i2), e3.wysiwyg.popover.insertAdjacentElement("beforeend", a2), ae(e3, t3);
          ...
          if (r2 && (t3.parentElement.isEqualNode(n2.wysiwyg.element) || "LI" === t3.tagName)) {
            ...
            i2.setAttribute("type", "button"), i2.setAttribute("data-type", "up"), i2.setAttribute("aria-label", window.VditorI18n.up + "<" + (0, d.ns)("⇧⌘U") + ">"), i2.innerHTML = '<svg><use xlink:href="#vditor-icon-up"></use></svg>', i2.className = "vditor-icon vditor-tooltipped vditor-tooltipped__n", i2.onclick = function() {
              e3.insertNode(document.createElement("wbr")), r2.insertAdjacentElement("beforebegin", t3), (0, D.ib)(n2.wysiwyg.element, e3), Y(n2), oe(n2), Ae(n2);
          ...
          if (r2 && (t3.parentElement.isEqualNode(n2.wysiwyg.element) || "LI" === t3.tagName)) {
            ...
            i2.setAttribute("type", "button"), i2.setAttribute("data-type", "down"), i2.setAttribute("aria-label", window.VditorI18n.down + "<" + (0, d.ns)("⇧⌘D") + ">"), i2.innerHTML = '<svg><use xlink:href="#vditor-icon-down"></use></svg>', i2.className = "vditor-icon vditor-tooltipped vditor-tooltipped__n", i2.onclick = function() {
              e3.insertNode(document.createElement("wbr")), r2.insertAdjacentElement("afterend", t3), (0, D.ib)(n2.wysiwyg.element, e3), Y(n2), oe(n2), Ae(n2);
            }, n2.wysiwyg.popover.insertAdjacentElement("beforeend", i2);
          }
        }, ce = function(e3, t3) {
          ...
          n2.setAttribute("type", "button"), n2.setAttribute("data-type", "remove"), n2.setAttribute("aria-label", window.VditorI18n.remove + "<" + (0, d.ns)("⇧⌘X") + ">"), n2.innerHTML = '<svg><use xlink:href="#vditor-icon-trashcan"></use></svg>', n2.className = "vditor-icon vditor-tooltipped vditor-tooltipped__n", n2.onclick = function() {
            var n3 = (0, D.zh)(t3);
            n3.setStartAfter(e3), (0, D.Hc)(n3), e3.remove(), Y(t3), oe(t3), ["H1", "H2", "H3", "H4", "H5", "H6"].includes(e3.tagName) && O(t3);
          }, t3.wysiwyg.popover.insertAdjacentElement("beforeend", n2);
        }, ue = function(e3, t3, n2, r2) {
          if (!n2.isComposing) {
            if ("Tab" === n2.key)
          ...
          e3.wysiwyg.popover.innerHTML = "";
          var r2 = function() {
            "" !== o2.value.trim() && (t3.innerHTML = o2.value), t3.setAttribute("href", l2.value), t3.setAttribute("title", d2.value), Y(e3);
          };
          ...
          a2.appendChild(l2), l2.className = "vditor-input", l2.setAttribute("placeholder", window.VditorI18n.link), l2.value = t3.getAttribute("href") || "", l2.oninput = function() {
            ...
            ie(e3, r3) || me(r3, n2) || ue(e3, t3, r3, d2);
          };
          ...
          s2.appendChild(d2), d2.className = "vditor-input", d2.setAttribute("placeholder", window.VditorI18n.tooltipText), d2.style.width = "60px", d2.value = t3.getAttribute("title") || "", d2.oninput = function() {
            ...
            ie(e3, r3) || me(r3, n2) || ue(e3, t3, r3, o2);
          }, ce(t3, e3), e3.wysiwyg.popover.insertAdjacentElement("beforeend", i2), e3.wysiwyg.popover.insertAdjacentElement("beforeend", a2), e3.wysiwyg.popover.insertAdjacentElement("beforeend", s2), ae(e3, t3);
        }, me = function(e3, t3) {
          if (!(0, d.yl)(e3) && !e3.shiftKey && "Enter" === e3.key || "Escape" === e3.key)
            return t3 && (0, D.Hc)(t3), e3.preventDefault(), e3.stopPropagation(), true;
        }, fe = function(e3) {
          "wysiwyg" === e3.currentMode ? oe(e3) : "ir" === e3.currentMode && X(e3);
          ...
          for (var r2 = e3.startContainer.parentElement, o2 = false, a2 = "", l2 = "", s2 = function(e4) {
            var t4 = $(e4.startContainer), n3 = Q(e4.startContainer), r3 = e4.startContainer.textContent, o3 = e4.startOffset, a3 = "", l3 = "";
          ...
          t3.prefix && this.element.children[0].addEventListener((0, d.Le)(), function(n3) {
              ...
              if (!(e4.wysiwyg.composingLock && n4 instanceof CustomEvent)) {
                ...
                if (t4.classList.contains("vditor-menu--current"))
                  if ("strike" === l3 && (l3 = "strikeThrough"), "quote" === l3) {
                    ...
                    "link" === l3 ? a3.collapsed ? (a3.selectNode(a3.startContainer.parentElement), document.execCommand("unlink", false, "")) : document.execCommand("unlink", false, "") : "check" === l3 || "list" === l3 || "ordered-list" === l3 ? (rt(e4, a3, l3), (0, D.ib)(e4.wysiwyg.element, a3), r3 = false, t4.classList.remove("vditor-menu--current")) : (r3 = false, t4.classList.remove("vditor-menu--current"), "" === a3.toString() ? he(a3, e4, l3) : document.execCommand(l3, false, ""));
                else {
                  ...
                  if ("quote" === l3) {
                    ...
                    rt(e4, a3, l3, false), (0, D.ib)(e4.wysiwyg.element, a3), r3 = false, c(e4.toolbar.elements, ["check", "list", "ordered-list"]), t4.classList.add("vditor-menu--current");
                  else if ("inline-code" === l3) {
                    if ("" === a3.toString())
                    ...
                    if ("" === a3.toString()) {
                      ...
                      f2.innerText = i.g.ZWSP, a3.insertNode(f2), a3.setStart(f2.firstChild, 1), a3.collapse(true), pe(e4, f2, a3);
                      var v2 = e4.wysiwyg.popover.querySelector("input");
                      v2.value = "", v2.focus(), o3 = false;
                    } else {
                      (m2 = document.createElement("a")).setAttribute("href", ""), m2.innerHTML = a3.toString(), a3.surroundContents(m2), a3.insertNode(m2), (0, D.Hc)(a3), pe(e4, m2, a3);
            ...
            }(e3, r2.element.children[0], n3) : "ir" === e3.currentMode ? xt(e3, r2.element.children[0], t3.prefix || "", t3.suffix || "") : Re(e3, r2.element.children[0], t3.prefix || "", t3.suffix || ""));
          });
        }, ye = (F = function(e3, t3) {
          return F = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(e4, t4) {
            e4.__proto__ = t4;
          } || function(e4, t4) {
            for (var n2 in t4)
          ...
          F(e3, t3), e3.prototype = null === t3 ? Object.create(t3) : (n2.prototype = t3.prototype, new n2());
        }), be = function(e3, t3, n2) {
          var r2;
          if ("string" != typeof n2 ? (h(e3, ["subToolbar", "hint"]), n2.preventDefault(), r2 = a(e3)) : r2 = n2, e3.currentMode !== t3 || "string" == typeof n2) {
            if (e3.devtools && e3.devtools.renderEchart(e3), "both" === e3.options.preview.mode && "sv" === t3 ? e3.preview.element.style.display = "block" : e3.preview.element.style.display = "none", p(e3.toolbar.elements, i.g.EDIT_TOOLBARS), c(e3.toolbar.elements, i.g.EDIT_TOOLBARS), m(e3.toolbar.elements, ["outdent", "indent"]), "ir" === t3)
              ...
              var o2 = De(r2, e3);
              "<div data-block='0'></div>" === o2 && (o2 = ""), e3.sv.element.innerHTML = o2, Ie(e3, { enableAddUndoStack: true, enableHint: false, enableInput: false }), z(e3);
            }
            e3.undo.resetIcon(e3), "string" != typeof n2 && (e3[e3.currentMode].element.focus(), fe(e3)), O(e3), G(e3), e3.toolbar.elements["edit-mode"] && (e3.toolbar.elements["edit-mode"].querySelectorAll("button").forEach(function(e4) {
          ...
          return ye(t3, e3), t3.prototype._bindEvent = function(e4, t4, n2) {
            var r2 = this.element.children[0];
            g(e4, t4, r2, n2.level), t4.children.item(0).addEventListener((0, d.Le)(), function(t5) {
              be(e4, "wysiwyg", t5), t5.preventDefault(), t5.stopPropagation();
            }), t4.children.item(1).addEventListener((0, d.Le)(), function(t5) {
              be(e4, "ir", t5), t5.preventDefault(), t5.stopPropagation();
            }), t4.children.item(2).addEventListener((0, d.Le)(), function(t5) {
              be(e4, "sv", t5), t5.preventDefault(), t5.stopPropagation();
            });
          }, t3;
        }(ge), Ee = function(e3, t3) {
          ...
          t3.addEventListener("dragstart", function(e4) {
            ...
            t4.dataTransfer.getData(i.g.DROP_EDITOR) ? dt(e3) : (t4.dataTransfer.types.includes("Files") || t4.dataTransfer.types.includes("text/html")) && Mt(e3, t4, { pasteCode: function(e4) {
              document.execCommand("insertHTML", false, e4);
            } });
          });
        }, Te = function(e3, t3, n2) {
            ...
            if (!t4.isComposing && e3.options.keydown && e3.options.keydown(t4), !(e3.options.hint.extend.length > 1 || e3.toolbar.elements.emoji) || !e3.hint.select(t4, e3)) {
              if (e3.options.comment.enable && "wysiwyg" === e3.currentMode && ("Backspace" === t4.key || P("⌘X", t4)) && e3.wysiwyg.getComments(e3), "sv" === e3.currentMode) {
                if (function(e4, t5) {
                  ...
                  if (!u2 && 0 === l2.startOffset && c2 && c2.previousElementSibling && "blockquote-marker" === c2.previousElementSibling.getAttribute("data-type") && (u2 = c2.previousElementSibling), u2 && "Enter" === t5.key && !(0, d.yl)(t5) && !t5.altKey && "" === u2.nextElementSibling.textContent.trim() && (0, D.im)(u2, e4.sv.element, l2).start === u2.textContent.length)
                    return "padding" === (null === (n3 = u2.previousElementSibling) || void 0 === n3 ? void 0 : n3.getAttribute("data-type")) && u2.previousElementSibling.setAttribute("data-action", "enter-remove"), u2.remove(), Ie(e4), t5.preventDefault(), true;
                  ...
                  if (f2 || m2 && "task-marker" !== m2.nextElementSibling.getAttribute("data-type") && (f2 = m2), f2 || 0 !== l2.startOffset || !c2 || !c2.previousElementSibling || "li-marker" !== c2.previousElementSibling.getAttribute("data-type") && "task-marker" !== c2.previousElementSibling.getAttribute("data-type") || (f2 = c2.previousElementSibling), f2) {
                    ...
                    if (h2 && (g2 = f2.previousElementSibling.previousElementSibling.previousElementSibling), v2 === f2.textContent.length) {
                      if ("Enter" === t5.key && !(0, d.yl)(t5) && !t5.altKey && !t5.shiftKey && "" === f2.nextElementSibling.textContent.trim())
                        return "padding" === (null === (r2 = g2.previousElementSibling) || void 0 === r2 ? void 0 : r2.getAttribute("data-type")) ? (g2.previousElementSibling.remove(), V(e4)) : (h2 && (g2.remove(), f2.previousElementSibling.previousElementSibling.remove(), f2.previousElementSibling.remove()), f2.nextElementSibling.remove(), f2.remove(), Ie(e4)), t5.preventDefault(), true;
                      if ("Tab" === t5.key)
                        return g2.insertAdjacentHTML("beforebegin", '<span data-type="padding">' + g2.textContent.replace(/\S/g, " ") + "</span>"), /^\d/.test(g2.textContent) && (g2.textContent = g2.textContent.replace(/^\d{1,}/, "1"), l2.selectNodeContents(f2.firstChild), l2.collapse(false)), V(e4), t5.preventDefault(), true;
                    }
                  }
                  if (ut(e4, l2, t5))
                    return true;
                  ...
                  if ("Enter" === t5.key && !(0, d.yl)(t5) && !t5.altKey && !t5.shiftKey && w2) {
                    ...
                    if (E2) {
                      if ("enter-remove" === (null === (i2 = E2.previousElementSibling) || void 0 === i2 ? void 0 : i2.getAttribute("data-action")))
                        return E2.previousElementSibling.remove(), Ie(e4), t5.preventDefault(), true;
                      L2 += Oe(E2);
                    }
                    return l2.insertNode(document.createTextNode(L2)), l2.collapse(false), w2 && "" !== w2.textContent.trim() && !k2 ? V(e4) : Ie(e4), t5.preventDefault(), true;
                  }
                  if ("Backspace" === t5.key && !(0, d.yl)(t5) && !t5.altKey && !t5.shiftKey) {
                    if (E2 && "newline" === (null === (o2 = E2.previousElementSibling) || void 0 === o2 ? void 0 : o2.getAttribute("data-type")) && 1 === (0, D.im)(E2, e4.sv.element, l2).start && -1 === E2.getAttribute("data-type").indexOf("code-block-"))
                      return l2.setStart(E2, 0), l2.extractContents(), "" !== E2.textContent.trim() ? V(e4) : Ie(e4), t5.preventDefault(), true;
                    if (w2 && 0 === (0, D.im)(w2, e4.sv.element, l2).start && w2.previousElementSibling) {
                      l2.extractContents();
                      var M2 = w2.previousElementSibling.lastElementChild;
                      return "newline" === M2.getAttribute("data-type") && (M2.remove(), M2 = w2.previousElementSibling.lastElementChild), "newline" !== M2.getAttribute("data-type") && (M2.insertAdjacentHTML("afterend", w2.innerHTML), w2.remove()), "" === w2.textContent.trim() || (null === (a2 = w2.previousElementSibling) || void 0 === a2 ? void 0 : a2.querySelector('[data-type="code-block-open-marker"]')) ? ("newline" !== M2.getAttribute("data-type") && (l2.selectNodeContents(M2.lastChild), l2.collapse(false)), Ie(e4)) : V(e4), t5.preventDefault(), true;
                    }
                  }
                  return false;
                }(e3, t4))
                ...
                if (function(e4, t5) {
                  ...
                  if (!Ze(t5, e4, r2))
                    return false;
                  if (Je(n3, e4, t5), St(n3), "Enter" !== t5.key && "Tab" !== t5.key && "Backspace" !== t5.key && -1 === t5.key.indexOf("Arrow") && !(0, d.yl)(t5) && "Escape" !== t5.key && "Delete" !== t5.key)
                    return false;
                  ...
                  if (l2) {
                    ...
                    if ("0" === l2.getAttribute("data-block")) {
                      if (bt(e4, t5, l2.firstElementChild, n3))
                        return true;
                      if (tt(e4, t5, n3, l2.firstElementChild, l2))
                        return true;
                      if ("yaml-front-matter" !== l2.getAttribute("data-type") && nt(e4, t5, n3, l2.firstElementChild, l2))
                        return true;
                    }
                  }
                  if (wt(e4, n3, t5, a2))
                  ...
                  if (c2 && !t5.shiftKey && t5.altKey && "Enter" === t5.key) {
                    ...
                    return u2.setAttribute("data-block", "0"), u2.innerHTML = "\n", n3.insertNode(u2), n3.collapse(true), (0, D.Hc)(n3), Y(e4), Ae(e4), t5.preventDefault(), true;
                  }
                  var p2, m2 = (0, b.W)(r2);
                  if (m2) {
                    if ("H6" === m2.tagName && r2.textContent.length === n3.startOffset && !(0, d.yl)(t5) && !t5.shiftKey && !t5.altKey && "Enter" === t5.key) {
                      ...
                      return f2.textContent = "\n", f2.setAttribute("data-block", "0"), r2.parentElement.insertAdjacentElement("afterend", f2), n3.setStart(f2, 0), (0, D.Hc)(n3), Y(e4), Ae(e4), t5.preventDefault(), true;
                    }
                    var v2;
                    if (P("⌘=", t5))
                      return (v2 = parseInt(m2.tagName.substr(1), 10) - 1) > 0 && (te(e4, "h" + v2), Y(e4)), t5.preventDefault(), true;
                    if (P("⌘-", t5))
                      return (v2 = parseInt(m2.tagName.substr(1), 10) + 1) < 7 && (te(e4, "h" + v2), Y(e4)), t5.preventDefault(), true;
                    "Backspace" !== t5.key || (0, d.yl)(t5) || t5.shiftKey || t5.altKey || 1 !== m2.textContent.length || ne(e4);
                  }
                  if (Et(e4, n3, t5))
                    return true;
                    ...
                    if (o2) {
                      if (o2.previousElementSibling && o2.previousElementSibling.classList.contains("vditor-wysiwyg__block") && "0" === o2.previousElementSibling.getAttribute("data-block") && "UL" !== o2.tagName && "OL" !== o2.tagName) {
                        ...
                        if (0 === k2 && 0 === n3.startOffset || 1 === k2 && o2.innerText.startsWith(i.g.ZWSP))
                          return re(o2.previousElementSibling.lastElementChild, e4, false), "" === o2.innerHTML.trim().replace(i.g.ZWSP, "") && (o2.remove(), Y(e4)), t5.preventDefault(), true;
                      }
                      ...
                      if ("" === n3.toString() && 3 === r2.nodeType && "\n" === r2.textContent.charAt(S2 - 2) && r2.textContent.charAt(S2 - 1) !== i.g.ZWSP && ["STRONG", "STRIKE", "S", "I", "EM", "B"].includes(r2.parentElement.tagName))
                        return r2.textContent = r2.textContent.substring(0, S2 - 1) + i.g.ZWSP, n3.setStart(r2, S2), n3.collapse(true), Y(e4), t5.preventDefault(), true;
                  ...
                  if (Xe(n3, t5.key), "ArrowDown" === t5.key) {
                ...
                if (c2 && "PRE" === c2.tagName) {
                  ...
                  if (bt(e4, t5, c2, n3))
                    return true;
                  if (("math-block" === u2.getAttribute("data-type") || "html-block" === u2.getAttribute("data-type")) && nt(e4, t5, n3, u2, c2.parentElement))
                    return true;
                  if (tt(e4, t5, n3, u2, c2.parentElement))
                    return true;
                }
                ...
                if (w2) {
                  var E2;
                  if (P("⌘=", t5))
                    return (E2 = w2.querySelector(".vditor-ir__marker--heading")) && E2.textContent.trim().length > 1 && At(e4, E2.textContent.substr(1)), t5.preventDefault(), true;
                  if (P("⌘-", t5))
                    return (E2 = w2.querySelector(".vditor-ir__marker--heading")) && E2.textContent.trim().length < 6 && At(e4, E2.textContent.trim() + "# "), t5.preventDefault(), true;
                }
                var k2 = (0, y.F9)(r2);
                if ("Backspace" === t5.key && !(0, d.yl)(t5) && !t5.shiftKey && !t5.altKey && "" === n3.toString()) {
                  if (kt(e4, n3, t5, s2))
                  ...
                  if (k2 && k2.previousElementSibling && "UL" !== k2.tagName && "OL" !== k2.tagName && ("code-block" === k2.previousElementSibling.getAttribute("data-type") || "math-block" === k2.previousElementSibling.getAttribute("data-type"))) {
                    ...
                    if (0 === S2 || 1 === S2 && k2.innerText.startsWith(i.g.ZWSP))
                      return n3.selectNodeContents(k2.previousElementSibling.querySelector(".vditor-ir__marker--pre code")), n3.collapse(false), q(n3, e4), "" === k2.textContent.trim().replace(i.g.ZWSP, "") && (k2.remove(), Ct(e4)), t5.preventDefault(), true;
                  }
                  if (w2) {
                ...
                }), !Lt(t5, k2, n3))) && (Xe(n3, t5.key), !k2 || !j(k2, e4, t5, n3) || (t5.preventDefault(), 0)));
              }(e3, t4))
                return;
              ...
              if ((0, d.yl)(t4) && t4.altKey && !t4.shiftKey && /^Digit[1-6]$/.test(t4.code)) {
                if ("wysiwyg" === e3.currentMode) {
                  ...
                  (0, y.lG)(getSelection().getRangeAt(0).startContainer, n2) ? ne(e3) : te(e3, n2), Y(e3);
                } else
                  "sv" === e3.currentMode ? je(e3, "#".repeat(parseInt(t4.code.replace("Digit", ""), 10)) + " ") : "ir" === e3.currentMode && At(e3, "#".repeat(parseInt(t4.code.replace("Digit", ""), 10)) + " ");
                return t4.preventDefault(), true;
              }
              if ((0, d.yl)(t4) && t4.altKey && !t4.shiftKey && /^Digit[7-9]$/.test(t4.code))
                return "Digit7" === t4.code ? be(e3, "wysiwyg", t4) : "Digit8" === t4.code ? be(e3, "ir", t4) : "Digit9" === t4.code && be(e3, "sv", t4), true;
          ...
          t3.addEventListener("selectstart", function(n2) {
            t3.onmouseup = function() {
              setTimeout(function() {
                var t4 = Ee(e3[e3.currentMode].element);
          ...
          i2 = i2.indexOf('data-type="footnotes-link"') > -1 || i2.indexOf('data-type="link-ref-defs-block"') > -1 ? "<div data-block='0'>" + i2 + "</div>" : "<div data-block='0'>" + i2.replace(/<span data-type="newline"><br \/><span style="display: none">\n<\/span><\/span><span data-type="newline"><br \/><span style="display: none">\n<\/span><\/span></g, '<span data-type="newline"><br /><span style="display: none">\n</span></span><span data-type="newline"><br /><span style="display: none">\n</span></span></div><div data-block="0"><') + "</div>", r2.isEqualNode(e3.sv.element) ? r2.innerHTML = i2 : r2.outerHTML = i2, (0, D.ib)(e3.sv.element, n2), Ae(e3);
          ...
          w("SpinVditorSVDOM", e3, "argument", t3.options.debugger);
          var n2 = t3.lute.SpinVditorSVDOM(e3);
          return e3 = n2.indexOf('data-type="footnotes-link"') > -1 || n2.indexOf('data-type="link-ref-defs-block"') > -1 ? "<div data-block='0'>" + n2 + "</div>" : "<div data-block='0'>" + n2.replace(/<span data-type="newline"><br \/><span style="display: none">\n<\/span><\/span><span data-type="newline"><br \/><span style="display: none">\n<\/span><\/span></g, '<span data-type="newline"><br /><span style="display: none">\n</span></span><span data-type="newline"><br /><span style="display: none">\n</span></span></div><div data-block="0"><') + "</div>", w("SpinVditorSVDOM", e3, "result", t3.options.debugger), e3;
        }, Oe = function(e3) {
            ...
            if ("li-marker" === o2 || "blockquote-marker" === o2 || "task-marker" === o2 || "padding" === o2) {
              ...
              if ("li-marker" !== o2 || "code-block-open-marker" !== t3 && "code-block-info" !== t3)
                if ("code-block-close-marker" === t3 && n2.nextElementSibling.isSameNode(e3)) {
                  var l2 = Ne(e3, "code-block-open-marker");
          ...
          if (a2) {
            ...
            if (("check" === o2 || "list" === o2 || "ordered-list" === o2 || "quote" === o2) && l2) {
              ...
              var c2 = Ne(l2, "newline");
              return c2 ? c2.insertAdjacentText("afterend", d2) : a2.insertAdjacentText("afterbegin", d2), void V(e3);
            }
            (0, D.ib)(e3.sv.element, i2), Ie(e3);
          }
        }, Pe = function(e3) {
            ...
            return Ve(this, function(g2) {
              switch (g2.label) {
                ...
                case 4:
                  ...
                  if (l2 = Pe(e3), e3.upload.range = (0, D.zh)(e3), s2 = function(e4, t4) {
                    e4.tip.hide();
          ...
          O(e3), Y(e3, { enableAddUndoStack: true, enableHint: true, enableInput: true });
        }, Ge = function(e3, t3) {
          return Object.defineProperty ? Object.defineProperty(e3, "raw", { value: t3 }) : e3.raw = t3, e3;
        }, Ke = function(e3, t3, n2, r2) {
          return new (n2 || (n2 = Promise))(function(i2, o2) {
            function a2(e4) {
              try {
                s2(r2.next(e4));
          ...
          void 0 === t3 && (t3 = { enableAddUndoStack: true, enableHint: false, enableInput: true }), "wysiwyg" === e3.currentMode ? Y(e3, t3) : "ir" === e3.currentMode ? Ct(e3, t3) : "sv" === e3.currentMode && Ie(e3, t3);
          ...
          if (l2) {
            ...
            if (!((0, d.yl)(r2) || r2.shiftKey || r2.altKey || "Backspace" !== r2.key || l2.previousElementSibling || "" !== e3.toString() || 0 !== (0, D.im)(l2, t3[t3.currentMode].element, e3).start))
              return l2.nextElementSibling ? (l2.parentElement.insertAdjacentHTML("beforebegin", '<p data-block="0"><wbr>' + l2.innerHTML + "</p>"), l2.remove()) : l2.parentElement.outerHTML = '<p data-block="0"><wbr>' + l2.innerHTML + "</p>", (0, D.ib)(t3[t3.currentMode].element, e3), dt(t3), r2.preventDefault(), true;
            if (!(0, d.yl)(r2) && !r2.shiftKey && !r2.altKey && "Backspace" === r2.key && "" === l2.textContent.trim().replace(i.g.ZWSP, "") && "" === e3.toString() && "LI" === (null === (o2 = l2.previousElementSibling) || void 0 === o2 ? void 0 : o2.tagName))
              return l2.previousElementSibling.insertAdjacentText("beforeend", "\n\n"), e3.selectNodeContents(l2.previousElementSibling), e3.collapse(false), l2.remove(), (0, D.ib)(t3[t3.currentMode].element, e3), dt(t3), r2.preventDefault(), true;
            if (!(0, d.yl)(r2) && !r2.altKey && "Tab" === r2.key) {
              ...
              if ((0 === e3.startOffset && (3 === a2.nodeType && !a2.previousSibling || 3 !== a2.nodeType && "LI" === a2.nodeName) || l2.classList.contains("vditor-task") && 1 === e3.startOffset && 3 !== a2.previousSibling.nodeType && "INPUT" === a2.previousSibling.tagName) && (s2 = true), s2 || "" !== e3.toString())
                return r2.shiftKey ? ot(t3, l2, e3, l2.parentElement) : it(t3, l2, e3), r2.preventDefault(), true;
            }
          }
          return false;
        }, ut = function(e3, t3, n2) {
          if (e3.options.tab && "Tab" === n2.key)
            return n2.shiftKey || ("" === t3.toString() ? (t3.insertNode(document.createTextNode(e3.options.tab)), t3.collapse(false)) : (t3.extractContents(), t3.insertNode(document.createTextNode(e3.options.tab)), t3.collapse(false))), (0, D.Hc)(t3), dt(e3), n2.preventDefault(), true;
        }, pt = function(e3, t3, n2, r2) {
          if (n2) {
            if (!(0, d.yl)(e3) && !e3.altKey && "Enter" === e3.key) {
              var i2 = String.raw(Z || (Z = Ge(["", ""], ["", ""])), n2.textContent).replace(/\\\|/g, "").trim(), o2 = i2.split("|");
              if (i2.startsWith("|") && i2.endsWith("|") && o2.length > 3) {
                var a2 = o2.map(function() {
                  return "---";
                }).join("|");
                return a2 = n2.textContent + "\n" + a2.substring(3, a2.length - 3) + "\n|<wbr>", n2.outerHTML = t3.lute.SpinVditorDOM(a2), (0, D.ib)(t3[t3.currentMode].element, r2), dt(t3), Ae(t3), e3.preventDefault(), true;
              }
              if (lt(n2.innerHTML) && n2.previousElementSibling) {
                var l2 = "", s2 = n2.innerHTML.trimRight().split("\n");
                return s2.length > 1 && (s2.pop(), l2 = '<p data-block="0">' + s2.join("\n") + "</p>"), n2.insertAdjacentHTML("afterend", l2 + '<hr data-block="0"><p data-block="0"><wbr>\n</p>'), n2.remove(), (0, D.ib)(t3[t3.currentMode].element, r2), dt(t3), Ae(t3), e3.preventDefault(), true;
              }
              if (st(n2.innerHTML))
                return "wysiwyg" === t3.currentMode ? n2.outerHTML = t3.lute.SpinVditorDOM(n2.innerHTML + '<p data-block="0"><wbr>\n</p>') : n2.outerHTML = t3.lute.SpinVditorIRDOM(n2.innerHTML + '<p data-block="0"><wbr>\n</p>'), (0, D.ib)(t3[t3.currentMode].element, r2), dt(t3), Ae(t3), e3.preventDefault(), true;
            }
          ...
          "TH" === n2.tagName ? n2.parentElement.parentElement.insertAdjacentHTML("afterend", "<tbody><tr>" + r2 + "</tr></tbody>") : n2.parentElement.insertAdjacentHTML("afterend", "<tr>" + r2 + "</tr>"), dt(e3);
          ...
          if ("TD" === n2.tagName) {
            ...
            n2.parentElement.previousElementSibling ? t3.selectNodeContents(n2.parentElement.previousElementSibling.lastElementChild) : t3.selectNodeContents(r2.previousElementSibling.lastElementChild.lastElementChild), 1 === r2.childElementCount ? r2.remove() : n2.parentElement.remove(), t3.collapse(false), (0, D.Hc)(t3), dt(e3);
          }
          ...
          if (i2) {
            ...
            if ("ArrowDown" === t3.key) {
              ...
              if (t3.preventDefault(), !(s2 = i2.parentElement).nextElementSibling && "TD" === i2.tagName)
                return a2.nextElementSibling ? (n2.selectNodeContents(a2.nextElementSibling), n2.collapse(true), (0, D.Hc)(n2)) : Ye(e3, "afterend"), true;
            ...
            if (!(0, d.yl)(t3) && !t3.shiftKey && !t3.altKey && "Backspace" === t3.key && 0 === n2.startOffset && "" === n2.toString())
              return !et(i2, n2, false) && a2 && ("" === a2.textContent.trim() ? (a2.outerHTML = '<p data-block="0"><wbr>\n</p>', (0, D.ib)(e3[e3.currentMode].element, n2)) : (n2.setStartBefore(a2), n2.collapse(true)), dt(e3)), t3.preventDefault(), true;
            if (P("⇧⌘F", t3))
              return ft(e3, n2, i2), t3.preventDefault(), true;
            if (P("⌘=", t3))
              return mt(e3, n2, i2), t3.preventDefault(), true;
            if (P("⇧⌘G", t3))
              return vt(e3, a2, i2, "beforebegin"), t3.preventDefault(), true;
            if (P("⇧⌘=", t3))
              return vt(e3, a2, i2), t3.preventDefault(), true;
            if (P("⌘-", t3))
              return ht(e3, n2, i2), t3.preventDefault(), true;
            if (P("⇧⌘-", t3))
              return gt(e3, n2, a2, i2), t3.preventDefault(), true;
            if (P("⇧⌘L", t3)) {
              if ("ir" === e3.currentMode)
                return at(a2, "left"), dt(e3), t3.preventDefault(), true;
              if (m2 = e3.wysiwyg.popover.querySelector('[data-type="left"]'))
                return m2.click(), t3.preventDefault(), true;
            }
            if (P("⇧⌘C", t3)) {
              if ("ir" === e3.currentMode)
                return at(a2, "center"), dt(e3), t3.preventDefault(), true;
              if (m2 = e3.wysiwyg.popover.querySelector('[data-type="center"]'))
                return m2.click(), t3.preventDefault(), true;
            }
            if (P("⇧⌘R", t3)) {
              if ("ir" === e3.currentMode)
                return at(a2, "right"), dt(e3), t3.preventDefault(), true;
              var m2;
          ...
          if (e3.options.tab && "Tab" === t3.key && !t3.shiftKey && "" === r2.toString())
            return r2.insertNode(document.createTextNode(e3.options.tab)), r2.collapse(false), dt(e3), t3.preventDefault(), true;
          if ("Backspace" === t3.key && !(0, d.yl)(t3) && !t3.shiftKey && !t3.altKey) {
            ...
            if ((0 === i2.start || 1 === i2.start && "\n" === n2.innerText) && "" === r2.toString())
              return n2.parentElement.outerHTML = '<p data-block="0"><wbr>' + n2.firstElementChild.innerHTML + "</p>", (0, D.ib)(e3[e3.currentMode].element, r2), dt(e3), t3.preventDefault(), true;
          }
          return !(0, d.yl)(t3) && !t3.altKey && "Enter" === t3.key && (n2.firstElementChild.textContent.endsWith("\n") || n2.firstElementChild.insertAdjacentText("beforeend", "\n"), r2.extractContents(), r2.insertNode(document.createTextNode("\n")), r2.collapse(false), (0, D.Hc)(r2), (0, d.vU)() || ("wysiwyg" === e3.currentMode ? ze(e3, r2) : R(e3, r2)), Ae(e3), t3.preventDefault(), true);
          ...
          if (a2 && "" === t3.toString()) {
            if ("Backspace" === n2.key && !(0, d.yl)(n2) && !n2.shiftKey && !n2.altKey && 0 === (0, D.im)(a2, e3[e3.currentMode].element, t3).start)
              return t3.insertNode(document.createElement("wbr")), a2.outerHTML = a2.innerHTML, (0, D.ib)(e3[e3.currentMode].element, t3), dt(e3), n2.preventDefault(), true;
            if (r2 && "Enter" === n2.key && !(0, d.yl)(n2) && !n2.shiftKey && !n2.altKey && "BLOCKQUOTE" === r2.parentElement.tagName) {
              ...
              if ("\n" === r2.innerHTML.replace(i.g.ZWSP, "") || "" === r2.innerHTML.replace(i.g.ZWSP, "") ? (l2 = true, r2.remove()) : r2.innerHTML.endsWith("\n\n") && (0, D.im)(r2, e3[e3.currentMode].element, t3).start === r2.textContent.length - 1 && (r2.innerHTML = r2.innerHTML.substr(0, r2.innerHTML.length - 2), l2 = true), l2)
                return a2.insertAdjacentHTML("afterend", '<p data-block="0">' + i.g.ZWSP + "<wbr>\n</p>"), (0, D.ib)(e3[e3.currentMode].element, t3), dt(e3), n2.preventDefault(), true;
            }
            var s2 = (0, y.F9)(o2);
            if ("wysiwyg" === e3.currentMode && s2 && P("⇧⌘;", n2))
              return t3.insertNode(document.createElement("wbr")), s2.outerHTML = '<blockquote data-block="0">' + s2.outerHTML + "</blockquote>", (0, D.ib)(e3.wysiwyg.element, t3), Y(e3), n2.preventDefault(), true;
            if (tt(e3, n2, t3, a2, a2))
              return true;
          ...
          if (i2) {
            if (P("⇧⌘J", n2)) {
              ...
              return o2.checked ? o2.removeAttribute("checked") : o2.setAttribute("checked", "checked"), dt(e3), n2.preventDefault(), true;
            }
            if ("Backspace" === n2.key && !(0, d.yl)(n2) && !n2.shiftKey && !n2.altKey && "" === t3.toString() && 1 === t3.startOffset && (3 === r2.nodeType && r2.previousSibling && "INPUT" === r2.previousSibling.tagName || 3 !== r2.nodeType)) {
              ...
              return (0, D.ib)(e3[e3.currentMode].element, t3), dt(e3), n2.preventDefault(), true;
            }
            if ("Enter" === n2.key && !(0, d.yl)(n2) && !n2.shiftKey && !n2.altKey) {
              ...
              return (0, D.ib)(e3[e3.currentMode].element, t3), dt(e3), Ae(e3), n2.preventDefault(), true;
            }
          }
          return false;
        }, kt = function(e3, t3, n2, r2) {
          if (3 !== t3.startContainer.nodeType) {
              ...
              switch (E2.label) {
                case 0:
                  return "true" !== e3[e3.currentMode].element.getAttribute("contenteditable") ? [2] : (t3.stopPropagation(), t3.preventDefault(), "clipboardData" in t3 ? (r2 = t3.clipboardData.getData("text/html"), o2 = t3.clipboardData.getData("text/plain"), a2 = t3.clipboardData.files) : (r2 = t3.dataTransfer.getData("text/html"), o2 = t3.dataTransfer.getData("text/plain"), t3.dataTransfer.types.includes("Files") && (a2 = t3.dataTransfer.items)), l2 = {}, s2 = function(t4, n3) {
                    ...
                    if (34 === t4.__internal_object__.Parent.Type && r3 && -1 === r3.indexOf("file://") && e3.options.upload.linkToImgUrl) {
                      ...
                      i2.open("POST", e3.options.upload.linkToImgUrl), e3.options.upload.token && i2.setRequestHeader("X-Upload-Token", e3.options.upload.token), e3.options.upload.withCredentials && (i2.withCredentials = true), qe(e3, i2), i2.setRequestHeader("Content-Type", "application/json; charset=utf-8"), i2.onreadystatechange = function() {
                ...
                case 8:
                  return "sv" !== e3.currentMode && ((g2 = (0, y.F9)((0, D.zh)(e3).startContainer)) && (b2 = (0, D.zh)(e3), e3[e3.currentMode].element.querySelectorAll("wbr").forEach(function(e4) {
                    ...
                    N(t4, e3);
                  })), e3.wysiwyg.triggerRemoveComment(e3), dt(e3), e3[e3.currentMode].element.scrollHeight - c2 > Math.min(e3[e3.currentMode].element.clientHeight, window.innerHeight) / 2 && Ae(e3), [2];
              }
            });
          });
        }, Tt = function(e3) {
          ...
          void 0 === t3 && (t3 = { enableAddUndoStack: true, enableHint: false, enableInput: true }), t3.enableHint && Tt(e3), clearTimeout(e3.ir.processTimeoutId), e3.ir.processTimeoutId = window.setTimeout(function() {
          ...
          if (r2) {
            ...
            i2 ? i2.innerHTML = t3 : (r2.insertAdjacentText("afterbegin", t3), n2.selectNodeContents(r2), n2.collapse(false)), R(e3, n2.cloneRange()), X(e3);
          }
        }, _t = function(e3, t3, n2) {
          ...
          if (t3.classList.contains("vditor-menu--current"))
            if ("quote" === o2) {
              ...
              "italic" === o2 ? _t(i2, e3, "em") : "bold" === o2 ? _t(i2, e3, "strong") : "strike" === o2 ? _t(i2, e3, "s") : "inline-code" === o2 ? _t(i2, e3, "code") : "check" !== o2 && "list" !== o2 && "ordered-list" !== o2 || (rt(e3, i2, o2), l2 = false, t3.classList.remove("vditor-menu--current"));
          else {
            ...
            if ("line" === o2) {
              ...
              "check" !== o2 && "list" !== o2 && "ordered-list" !== o2 || (rt(e3, i2, o2, false), l2 = false, c(e3.toolbar.elements, ["check", "list", "ordered-list"]), t3.classList.add("vditor-menu--current"));
          }
          (0, D.ib)(e3.ir.element, i2), Ct(e3), l2 && X(e3);
          ...
          function e3(e4) {
            ...
            this.splitChar = "", this.lastIndex = -1, this.fillEmoji = function(e5, n2) {
              ...
              if ("ir" === n2.currentMode) {
                ...
                if (a2)
                  return a2.textContent = i.g.ZWSP + r2.trimRight(), o2.selectNodeContents(a2), o2.collapse(false), Ct(n2), a2.parentElement.querySelectorAll("code").forEach(function(e6) {
              ...
              if (void 0 === i2)
                ...
                e4.options.hint.extend.forEach(function(n3) {
                  n3.key === t3.splitChar && (clearTimeout(t3.timeId), t3.timeId = window.setTimeout(function() {
                    return Ht(t3, void 0, void 0, function() {
                      var t4;
                      return Nt(this, function(r3) {
                        switch (r3.label) {
                          case 0:
          ...
          function e3(e4) {
            ...
            t3.className = "vditor-ir", t3.innerHTML = '<pre class="vditor-reset" placeholder="' + e4.options.placeholder + '"\n contenteditable="true" spellcheck="false"></pre>', this.element = t3.firstElementChild, this.bindEvent(e4), ke(e4, this.element), Se(e4, this.element), Le(e4, this.element), _e(e4, this.element), xe(e4, this.element), Me(e4, this.element), Te(e4, this.element, this.copy), Ce(e4, this.element, this.copy);
          }
          return e3.prototype.copy = function(e4, t3) {
            ...
            this.element.addEventListener("paste", function(t4) {
              ...
              if ("deleteByDrag" !== n2.inputType && "insertFromDrop" !== n2.inputType)
                return t3.preventInput ? (t3.preventInput = false, void Ct(e4, { enableAddUndoStack: true, enableHint: true, enableInput: true })) : void (t3.composingLock || "‘" === n2.data || "“" === n2.data || "《" === n2.data || R(e4, getSelection().getRangeAt(0).cloneRange(), false, n2));
            }), this.element.addEventListener("click", function(n2) {
              if ("INPUT" === n2.target.tagName)
                return n2.target.checked ? n2.target.setAttribute("checked", "checked") : n2.target.removeAttribute("checked"), t3.preventInput = true, void Ct(e4);
              var r2 = (0, D.zh)(e4), o2 = (0, y.fb)(n2.target, "vditor-ir__preview");
              if (o2 || (o2 = (0, y.fb)(r2.startContainer, "vditor-ir__preview")), o2 && (o2.previousElementSibling.firstElementChild ? r2.selectNodeContents(o2.previousElementSibling.firstElementChild) : r2.selectNodeContents(o2.previousElementSibling), r2.collapse(true), (0, D.Hc)(r2), Ae(e4)), "IMG" === n2.target.tagName) {
              ...
              if (!n2.isComposing && !(0, d.yl)(n2))
                if ("Enter" === n2.key && Ae(e4), X(e4), "Backspace" !== n2.key && "Delete" !== n2.key || "" === e4.ir.element.innerHTML || 1 !== e4.ir.element.childNodes.length || !e4.ir.element.firstElementChild || "P" !== e4.ir.element.firstElementChild.tagName || 0 !== e4.ir.element.firstElementChild.childElementCount || "" !== e4.ir.element.textContent && "\n" !== e4.ir.element.textContent) {
                  var r2 = (0, D.zh)(e4);
                  "Backspace" === n2.key ? ((0, d.vU)() && "\n" === r2.startContainer.textContent && 1 === r2.startOffset && (r2.startContainer.textContent = "", q(r2, e4)), t3.element.querySelectorAll(".language-math").forEach(function(e5) {
                    ...
                    t4 && t4.remove();
                  })) : n2.key.indexOf("Arrow") > -1 ? ("ArrowLeft" !== n2.key && "ArrowRight" !== n2.key || Tt(e4), q(r2, e4)) : 229 === n2.keyCode && "" === n2.code && "Unidentified" === n2.key && q(r2, e4);
          ...
          return e3.prototype.render = function(e4) {
            return "block" === e4.preview.element.style.display ? (0, Rt.k)(e4.preview.previewElement, this.element.lastElementChild, e4) : (0, Rt.k)(e4[e4.currentMode].element, this.element.lastElementChild, e4);
          ...
          function e3(e4) {
            this.composingLock = false, this.element = document.createElement("pre"), this.element.className = "vditor-sv vditor-reset", this.element.setAttribute("placeholder", e4.options.placeholder), this.element.setAttribute("contenteditable", "true"), this.element.setAttribute("spellcheck", "false"), this.bindEvent(e4), ke(e4, this.element), Le(e4, this.element), _e(e4, this.element), xe(e4, this.element), Me(e4, this.element), Te(e4, this.element, this.copy), Ce(e4, this.element, this.copy);
          }
          return e3.prototype.copy = function(e4, t3) {
            e4.stopPropagation(), e4.preventDefault(), e4.clipboardData.setData("text/plain", Ee(t3[t3.currentMode].element));
          }, e3.prototype.bindEvent = function(e4) {
            var t3 = this;
            this.element.addEventListener("paste", function(t4) {
              Mt(e4, t4, { pasteCode: function(e5) {
          ...
          function t3(t4, n2) {
            ...
            return i.g.CODE_THEME.forEach(function(e4) {
              ...
              "BUTTON" === e4.target.tagName && (h(t4, ["subToolbar"]), t4.options.preview.hljs.style = e4.target.textContent, (0, Zt.Y)(e4.target.textContent, t4.options.cdn), e4.preventDefault(), e4.stopPropagation());
          ...
          function t3(t4, n2) {
            ...
            return Object.keys(t4.options.preview.theme.list).forEach(function(e4) {
              ...
              "BUTTON" === e4.target.tagName && (h(t4, ["subToolbar"]), t4.options.preview.theme.current = e4.target.getAttribute("data-type"), (0, U.Z)(t4.options.preview.theme.current, t4.options.preview.theme.path), e4.preventDefault(), e4.stopPropagation());
          ...
          return an(t3, e3), t3.prototype.bindEvent = function(e4) {
            var t4 = this;
            this.element.lastElementChild.addEventListener((0, d.Le)(), function(n2) {
              ...
              if (r2) {
                ...
                o2.collapse(false), (0, D.Hc)(o2), t4.element.lastElementChild.style.display = "none", dt(e4);
              }
...
<script src="` + e5.options.cdn + "/dist/js/icons/" + e5.options.icon + '.js"><\/script></body></html>';
          ...
          return un(t3, e3), t3.prototype._bindEvent = function(e4, t4) {
            this.element.children[0].addEventListener((0, d.Le)(), function(n2) {
              ...
              }), e4.counter && (e4.counter.element.className = e4.counter.element.className.replace("__n", "__s"))), e4.devtools && e4.devtools.renderEchart(e4), t4.click && t4.click(n2, e4), z(e4), G(e4);
            });
          }, t3;
        }(ge), mn = function() {
          var e3 = function(t3, n2) {
          ...
          return mn(t3, e3), t3.prototype._bindEvent = function(e4, t4) {
            var n2 = this.element.children[0];
            n2.addEventListener((0, d.Le)(), function(r3) {
              r3.preventDefault(), clearTimeout(e4.wysiwyg.afterRenderTimeoutId), clearTimeout(e4.ir.processTimeoutId), clearTimeout(e4.sv.processTimeoutId), n2.classList.contains(i.g.CLASS_MENU_DISABLED) || (n2.blur(), n2.classList.contains("vditor-menu--current") ? ("wysiwyg" === e4.currentMode ? (ne(e4), Y(e4)) : "ir" === e4.currentMode && At(e4, ""), n2.classList.remove("vditor-menu--current")) : (h(e4, ["subToolbar"]), t4.style.display = "block"));
            });
            for (var r2 = 0; r2 < 6; r2++)
              t4.children.item(r2).addEventListener((0, d.Le)(), function(r3) {
                r3.preventDefault(), "wysiwyg" === e4.currentMode ? (te(e4, r3.target.getAttribute("data-tag")), Y(e4), n2.classList.add("vditor-menu--current")) : "ir" === e4.currentMode ? (At(e4, r3.target.getAttribute("data-value")), n2.classList.add("vditor-menu--current")) : je(e4, r3.target.getAttribute("data-value")), t4.style.display = "none";
              });
          }, t3;
        }(ge), vn = function() {
          var e3 = function(t3, n2) {
          ...
          function t3(t4, n2) {
            var r2 = e3.call(this, t4, n2) || this;
            return r2.element.children[0].addEventListener((0, d.Le)(), function(e4) {
              e4.preventDefault(), r2.element.firstElementChild.classList.contains(i.g.CLASS_MENU_DISABLED) || "sv" === t4.currentMode || Ye(t4, "afterend");
            }), r2;
          }
          return En(t3, e3), t3;
        }(ge), Sn = function() {
          ...
          function t3(t4, n2) {
            var r2 = e3.call(this, t4, n2) || this;
            return r2.element.children[0].addEventListener((0, d.Le)(), function(e4) {
              e4.preventDefault(), r2.element.firstElementChild.classList.contains(i.g.CLASS_MENU_DISABLED) || "sv" === t4.currentMode || Ye(t4, "beforebegin");
            }), r2;
          }
          return Sn(t3, e3), t3;
        }(ge), Mn = function() {
          ...
          function t3(t4, n2) {
            ...
            return r2.element.children[0].addEventListener((0, d.Le)(), function(e4) {
              if (e4.preventDefault(), !r2.element.firstElementChild.classList.contains(i.g.CLASS_MENU_DISABLED) && "sv" !== t4.currentMode) {
                var n3 = (0, D.zh)(t4), o2 = (0, y.lG)(n3.startContainer, "LI");
                o2 && ot(t4, o2, n3, o2.parentElement);
              }
            }), r2;
          }
          return Mn(t3, e3), t3;
          ...
          return _n(t3, e3), t3.prototype._bindEvent = function(e4) {
            var t4 = this;
            this.element.children[0].addEventListener((0, d.Le)(), function(n2) {
              n2.preventDefault();
          ...
          return Nn(t3, e3), t3.prototype._bindEvent = function(e4) {
            var t4, n2 = this;
              ...
              if (r2.preventDefault(), !n2.element.firstElementChild.classList.contains(i.g.CLASS_MENU_DISABLED)) {
                ...
                if (t4)
                  if (t4.isRecording) {
                    ...
                    We(e4, [a2]), n2.element.children[0].classList.remove("vditor-menu--current");
                  } else
                  ...
                  navigator.mediaDevices.getUserMedia({ audio: true }).then(function(r3) {
                    (t4 = new Hn(r3)).recorder.onaudioprocess = function(e5) {
                      if (t4.isRecording) {
          ...
          return Pn(t3, e3), t3.prototype._bindEvent = function(e4) {
            var t4 = this;
            this.element.children[0].addEventListener((0, d.Le)(), function(e5) {
              ...
              0 !== n2.target.files.length && We(e4, n2.target.files, n2.target);
            });
          }, t3;
        }(ge), Bn = function() {
          function e3(e4) {
            ...
            }), e4.options.toolbarConfig.hide && this.element.classList.add("vditor-toolbar--hide"), e4.options.toolbarConfig.pin && this.element.classList.add("vditor-toolbar--pin"), e4.options.counter.enable && (e4.counter = new $t(e4), this.element.appendChild(e4.counter.element));
          }
          ...
          return e3.prototype.clearStack = function(e4) {
            ...
            if (this[t3.currentMode].lastText = r2, t3[t3.currentMode].element.innerHTML = r2, "sv" !== t3.currentMode && t3[t3.currentMode].element.querySelectorAll(".vditor-" + t3.currentMode + "__preview[data-render='2']").forEach(function(e5) {
              ...
              (0, D.ib)(t3[t3.currentMode].element, t3[t3.currentMode].element.ownerDocument.createRange()), Ae(t3);
            else {
              var o2 = getSelection().getRangeAt(0);
              o2.setEndBefore(t3[t3.currentMode].element), o2.collapse(false);
            }
            O(t3), dt(t3, { enableAddUndoStack: false, enableHint: false, enableInput: true }), fe(t3), t3[t3.currentMode].element.querySelectorAll(".vditor-" + t3.currentMode + "__preview[data-render='2']").forEach(function(e5) {
              N(e5, t3);
          ...
          return e3.prototype.merge = function() {
            var e4, t3, n2;
            this.options && (this.options.toolbar ? this.options.toolbar = this.mergeToolbar(this.options.toolbar) : this.options.toolbar = this.mergeToolbar(this.defaultOptions.toolbar), (null === (t3 = null === (e4 = this.options.preview) || void 0 === e4 ? void 0 : e4.theme) || void 0 === t3 ? void 0 : t3.list) && (this.defaultOptions.preview.theme.list = this.options.preview.theme.list), (null === (n2 = this.options.hint) || void 0 === n2 ? void 0 : n2.emoji) && (this.defaultOptions.hint.emoji = this.options.hint.emoji), this.options.comment && (this.defaultOptions.comment = this.options.comment));
            var r2 = (0, Wn.T)(this.defaultOptions, this.options);
          ...
          function e3(e4) {
            ...
            n2.className = "vditor-wysiwyg", n2.innerHTML = '<pre class="vditor-reset" placeholder="' + e4.options.placeholder + '"\n contenteditable="true" spellcheck="false"></pre>\n<div class="vditor-panel vditor-panel--none"></div>\n<div class="vditor-panel vditor-panel--none">\n    <button type="button" aria-label="' + window.VditorI18n.comment + '" class="vditor-icon vditor-tooltipped vditor-tooltipped__n">\n        <svg><use xlink:href="#vditor-icon-comment"></use></svg>\n    </button>\n</div>', this.element = n2.firstElementChild, this.popover = n2.firstElementChild.nextElementSibling, this.selectPopover = n2.lastElementChild, this.bindEvent(e4), ke(e4, this.element), Se(e4, this.element), Le(e4, this.element), _e(e4, this.element), xe(e4, this.element), Me(e4, this.element), Te(e4, this.element, this.copy), Ce(e4, this.element, this.copy), e4.options.comment.enable && (this.selectPopover.querySelector("button").onclick = function() {
              ...
              p2 && (r2 ? (p2.insertAdjacentHTML("afterbegin", r2.innerHTML), r2.remove()) : "" === p2.textContent.trim().replace(i.g.ZWSP, "") && c2 && p2.remove()), a2.insertNode(s2), e4.options.comment.add(o2, a2.toString(), t3.getComments(e4, true)), Y(e4, { enableAddUndoStack: true, enableHint: false, enableInput: false }), t3.hideComment();
            });
          }
          return e3.prototype.getComments = function(e4, t3) {
            ...
            this.unbindListener(), window.addEventListener("scroll", this.scrollListener = function() {
              ...
              if ("deleteByDrag" !== n2.inputType && "insertFromDrop" !== n2.inputType) {
                ...
                if (t3.composingLock || "‘" === n2.data || "“" === n2.data || "《" === n2.data)
                  ...
                  if (i2 || (ee(e4, r2), i2 = (0, y.F9)(r2.startContainer)), i2) {
                    ...
                    c2 && "" === c2.textContent && (O(e4), c2.remove()), l2 && "code-block" !== i2.getAttribute("data-type") || d2 || st(i2.innerHTML) || lt(i2.innerHTML) && i2.previousElementSibling ? "function" == typeof e4.options.input && e4.options.input(a(e4)) : ze(e4, r2, n2);
                  }
                }
              }
            }), this.element.addEventListener("click", function(n2) {
              if ("INPUT" === n2.target.tagName) {
                var r2 = n2.target;
                return r2.checked ? r2.setAttribute("checked", "checked") : r2.removeAttribute("checked"), t3.preventInput = true, void Y(e4);
              }
              if ("IMG" !== n2.target.tagName || n2.target.parentElement.classList.contains("vditor-wysiwyg__preview")) {
                ...
                l2 || (l2 = (0, y.fb)((0, D.zh)(e4).startContainer, "vditor-wysiwyg__preview")), l2 && re(l2, e4), I(n2, e4);
              } else
                "link-ref" === n2.target.getAttribute("data-type") ? le(e4, n2.target) : function(e5, t4) {
                  var n3 = e5.target;
                  ...
                  s2.appendChild(d2), d2.className = "vditor-input", d2.setAttribute("placeholder", window.VditorI18n.title), d2.value = n3.getAttribute("title") || "", d2.oninput = function() {
                    ...
                    ie(t4, e6);
                  }, ce(n3, t4), t4.wysiwyg.popover.insertAdjacentElement("beforeend", i2), t4.wysiwyg.popover.insertAdjacentElement("beforeend", a3), t4.wysiwyg.popover.insertAdjacentElement("beforeend", s2), ae(t4, n3);
                }(n2, e4);
            }), this.element.addEventListener("keyup", function(t4) {
              if (!t4.isComposing && !(0, d.yl)(t4)) {
                "Enter" === t4.key && Ae(e4), "Backspace" !== t4.key && "Delete" !== t4.key || "" === e4.wysiwyg.element.innerHTML || 1 !== e4.wysiwyg.element.childNodes.length || !e4.wysiwyg.element.firstElementChild || "P" !== e4.wysiwyg.element.firstElementChild.tagName || 0 !== e4.wysiwyg.element.firstElementChild.childElementCount || "" !== e4.wysiwyg.element.textContent && "\n" !== e4.wysiwyg.element.textContent || (e4.wysiwyg.element.innerHTML = "");
                var n2 = (0, D.zh)(e4);
                if ("Backspace" === t4.key && (0, d.vU)() && "\n" === n2.startContainer.textContent && 1 === n2.startOffset && (n2.startContainer.textContent = ""), ee(e4, n2), oe(e4), "ArrowDown" === t4.key || "ArrowRight" === t4.key || "Backspace" === t4.key || "ArrowLeft" === t4.key || "ArrowUp" === t4.key) {
                  ...
                  if (r2)
                    if ("none" !== r2.previousElementSibling.style.display) {
                      ...
                      "ArrowDown" === t4.key || "ArrowRight" === t4.key ? re(r2, e4) : re(r2, e4, false);
                }
              }
            });
          }, e3;
        ...
        const Fn = function(e3) {
          ...
          return Kn(t3, e3), t3.prototype.setTheme = function(e4, t4, n2, r2) {
            this.vditor.options.theme = e4, W(this.vditor), t4 && (this.vditor.options.preview.theme.current = t4, (0, U.Z)(t4, r2 || this.vditor.options.preview.theme.path)), n2 && (this.vditor.options.preview.hljs.style = n2, (0, Zt.Y)(n2, this.vditor.options.cdn));
            ...
            e4 && e4.remove(), this.clearCache(), K(), this.vditor.wysiwyg.unbindListener();
            ...
            this.vditor = { currentMode: t4.mode, element: e4, hint: new Dt(t4.hint.extend), lute: void 0, options: t4, originalInnerHTML: e4.innerHTML, outline: new Pt(window.VditorI18n.outline), tip: new Wt() }, this.vditor.sv = new Ut(this.vditor), this.vditor.undo = new Un(), this.vditor.wysiwyg = new Gn(this.vditor), this.vditor.ir = new Ot(this.vditor), this.vditor.toolbar = new Bn(this.vditor), t4.resize.enable && (this.vditor.resize = new Vt(this.vditor)), this.vditor.toolbar.elements.devtools && (this.vditor.devtools = new s()), (t4.upload.url || t4.upload.handler) && (this.vditor.upload = new Ue()), (0, l.G)(t4._lutePath || t4.cdn + "/dist/js/lute/lute.min.js", "vditorLuteScript").then(function() {
              n2.vditor.lute = (0, jt.X)({ autoSpace: n2.vditor.options.preview.markdown.autoSpace, gfmAutoLink: n2.vditor.options.preview.markdown.gfmAutoLink, codeBlockPreview: n2.vditor.options.preview.markdown.codeBlockPreview, emojiSite: n2.vditor.options.hint.emojiPath, emojis: n2.vditor.options.hint.emoji, fixTermTypo: n2.vditor.options.preview.markdown.fixTermTypo, footnotes: n2.vditor.options.preview.markdown.footnotes, headingAnchor: false, inlineMathDigit: n2.vditor.options.preview.math.inlineDigit, linkBase: n2.vditor.options.preview.markdown.linkBase, linkPrefix: n2.vditor.options.preview.markdown.linkPrefix, listStyle: n2.vditor.options.preview.markdown.listStyle, mark: n2.vditor.options.preview.markdown.mark, mathBlockPreview: n2.vditor.options.preview.markdown.mathBlockPreview, paragraphBeginningSpace: n2.vditor.options.preview.markdown.paragraphBeginningSpace, sanitize: n2.vditor.options.preview.markdown.sanitize, toc: n2.vditor.options.preview.markdown.toc }), n2.vditor.preview = new Bt(n2.vditor), function(e5) {
                ...
                if (t5.className = "vditor-content", "left" === e5.options.outline.position && t5.appendChild(e5.outline.element), t5.appendChild(e5.wysiwyg.element.parentElement), t5.appendChild(e5.sv.element), t5.appendChild(e5.ir.element.parentElement), t5.appendChild(e5.preview.element), e5.toolbar.elements.devtools && t5.appendChild(e5.devtools.element), "right" === e5.options.outline.position && (e5.outline.element.classList.add("vditor-outline--right"), t5.appendChild(e5.outline.element)), e5.upload && t5.appendChild(e5.upload.element), e5.options.resize.enable && t5.appendChild(e5.resize.element), t5.appendChild(e5.hint.element), t5.appendChild(e5.tip.element), e5.element.appendChild(t5), t5.addEventListener("click", function() {
                  h(e5, ["subToolbar"]);
                }), e5.toolbar.elements.export && e5.element.insertAdjacentHTML("beforeend", '<iframe id="vditorExportIframe" style="width: 100%;height: 0;border: 0"></iframe>'), be(e5, e5.options.mode, J(e5)), document.execCommand("DefaultParagraphSeparator", false, "p"), navigator.userAgent.indexOf("iPhone") > -1 && void 0 !== window.visualViewport) {
