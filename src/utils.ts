...
export const DOCS_URL = !!process.env.ogUrl ? process.env.ogUrl : `https://vodtv.cn` || `https://viptv.work`

export const DIR_ROOT = resolve('../')
export const DIR_SRC = resolve('../docs')
