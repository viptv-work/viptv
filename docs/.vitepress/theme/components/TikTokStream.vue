<template>
  <div class="tiktok-stream" ref="tiktokStream" v-swipe="onSwipe" :style="state.style">
    <tiktok v-for="(tiktok, i) in tiktokData" :video="tiktok.video" :key="tiktok.id" :ref="(el) => {
    tiktokRefs[i] = el;
  }
    " />
  </div>
...
const TiktoksJson = [
  {
    "id": "tiktok_1",
    "video": "https://r2.998111.xyz/mp4/002.mp4"
  },
  {
    "id": "tiktok_2",
    "video": "https://r2.998111.xyz/mp4/003.mp4"
  },
  {
    "id": "tiktok_3",
    "video": "https://r2.998111.xyz/mp4/004.mp4"
  }
]
